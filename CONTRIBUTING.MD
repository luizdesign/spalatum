...
- [Editorconfig](http://gitlab.devel/frontend-platform/spalatum/blob/master/.editorconfig)
- [Eslint Airbnb](http://gitlab.devel/frontend-platform/spalatum/blob/master/.eslintrc.js)
